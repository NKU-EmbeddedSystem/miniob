...
public:
  ...
  RC create_index(Trx *trx, const char *index_name, int attr_count, const char **attribute_name);
...
private:
  ...
  bool find_if_exist_unique_record(int value_num, const Value *values);
private:
