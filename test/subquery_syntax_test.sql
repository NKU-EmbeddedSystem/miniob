...
--
select * from t1 where id > (select max(id) from t2 where id > t1.id and t1.id > 2);
select * from t1 where id in (select id from t2 where id > t1.id and t1.id > 2);
select * from t1 where id not in (select id from t2 where id > t1.id and t1.id > 2);
select * from t1 where t1.id > (select max(id) from t2 where t1.id > 1 and t2.id > t1.id);
select * from t1 where t1.id in (select id from t2 where t1.id > 1 and t2.id > t1.id);
select * from t1 where t1.id not in (select id from t2 where t1.id > 1 and t2.id > t1.id);
select * from t1, t2 where t1.id > (select max(id) from t3 where t1.id > t2.id and t3.id > t1.id and t3.id > t2.id);
select * from t1, t2 where t1.id in (select id from t3 where t1.id > t2.id and t3.id > t1.id and t3.id > t2.id);
select * from t1, t2 where t1.id not in (select id from t3 where t1.id > t2.id and t3.id > t1.id and t3.id > t2.id);
select * from t1, t2 where t1.id > (select max(id) from t3 where t1.id > t2.id and t3.id > t1.id);
select * from t1, t2 where t1.id in (select id from t3 where t1.id > t2.id and t3.id > t1.id);
select * from t1, t2 where t1.id not in (select id from t3 where t1.id > t2.id and t3.id > t1.id);
-- these should failed
select * from t1 where (select num2 from t2) < (select max(num2) from t2);
select * from t1 where (select max(num2) from t2) < (select num2 from t2);
select * from t1 where (select num2 from t2) < (select num2 from t2);
select * from t1 where (select max(num2) from t2) in (select max(num2) from t2);
select * from t1 where (select num2 from t2) in (select max(num2) from t2);
select * from t1 where (select max(num2) from t2) in (select num2 from t2);
select * from t1 where (select num2 from t2) in (select num2 from t2);
select * from t1 where (select max(num2) from t2) not in (select max(num2) from t2);
select * from t1 where (select num2 from t2) not in (select max(num2) from t2);
select * from t1 where (select max(num2) from t2) not in (select num2 from t2);
select * from t1 where (select num2 from t2) not in (select num2 from t2);
--
select * from t1 where 2 in id;
select * from t1 where 2 not in id;
select * from t1 where id in id;
select * from t1 where id not in id;
select * from t1 where (select num2 from t2) in num1;
select * from t1 where (select num2 from t2) not in num1;
select * from t1 where (select max(num2) from t2) in num1;
select * from t1 where (select max(num2) from t2) not in num1;
--
select * from t1 where id > (select * from t2);
select * from t1 where id > (select num2 from t2);
--
select * from t1 where 3 in (select num2 from t2);
select * from t1 where id in (select count(*) from t2);
select * from t1 where id > (select num2 from t2);
--
select * from t1 where id > (select max(num7) from t7);
select * from t1 where id in (select num7 from t7);
select * from t1 where id not in (select num7 from t7);
--
...
--
select * from t1 where id > (select max(id) from t2 where t1.id > 2);
select * from t1 where id in (select id from t2 where t1.id > 2);
select * from t1 where id not in (select id from t2 where t1.id > 2);
select * from t1, t2 where t1.id > (select max(id) from t3 where t1.id > t2.id);
select * from t1, t2 where t1.id in (select id from t3 where t1.id > t2.id);
select * from t1, t2 where t1.id not in (select id from t3 where t1.id > t2.id);
select * from t1, t2 where t1.id > (select max(id) from t3 where t2.id > 3 and t3.id > t1.id);
select * from t1, t2 where t1.id in (select id from t3 where t2.id > 3 and t3.id > t1.id);
select * from t1, t2 where t1.id not in (select id from t3 where t2.id > 3 and t3.id > t1.id);
